...
- (void) menuButtonDown:(MMShakeMenuButton *) button
{
    for (MMShakeMenuButton *item in _menuButtons) {
...
- (void) initSubViews
{
    ...
    MMShakeMenuButton *peopleButton = [[MMShakeMenuButton alloc] initWithFrame:CGRectMake(x, y, w, h)
    ...
    x += w + space;
    MMShakeMenuButton *songButton = [[MMShakeMenuButton alloc] initWithFrame:CGRectMake(x, y, w, h)
    ...
    x += w + space;
    MMShakeMenuButton *tvButton = [[MMShakeMenuButton alloc] initWithFrame:CGRectMake(x, y, w, h)
